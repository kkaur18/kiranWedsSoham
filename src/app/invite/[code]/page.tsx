...
export default async function InvitePage({ params }: Props) {
  ...
  let guest;
  try {
    guest = await getGuestByCode(params.code);
  } catch {
          ...
          <main className="min-h-screen flex items-center justify-center px-4 bg-[#FFFBF2] pt-20">
            <div className="max-w-md text-center">
              ...
              <p className="font-sans text-gray-500 text-sm leading-relaxed">
                ...
                Google Sheet ID and service account credentials.
              </p>
            </div>
          </main>
          <Footer />
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <h1 className="font-serif font-light text-gold mb-2" style={{ fontSize: 'clamp(2.5rem, 7vw, 4.5rem)' }}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-serif text-4xl text-maroon font-light">{t.invite.celebrationsTitle}</h2>
      ...
      <section className="py-16 px-4 bg-white" id="rsvp">
        <div className="max-w-xl mx-auto">
          <div className="text-center mb-10">
            <p className="font-sans text-xs tracking-[0.3em] uppercase text-maroon/60 mb-2">
              {t.invite.respondBy} {config.events.mehendi_haldi.dateDisplay}
            </p>
